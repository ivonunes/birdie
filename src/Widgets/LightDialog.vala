namespace Birdie.Widgets {
    ...
    public class LightDialog : Granite.Widgets.CompositedWindow {
        ...
        public static void set_default_theming (Gtk.Window ref_window) {
            Granite.Widgets.Utils.set_theming (ref_window, DECORATED_WINDOW_STYLESHEET,
                               Granite.StyleClass.DECORATED_WINDOW,
                               Gtk.STYLE_PROVIDER_PRIORITY_APPLICATION);

            Granite.Widgets.Utils.set_theming (ref_window, DECORATED_WINDOW_FALLBACK_STYLESHEET,
                               Granite.StyleClass.DECORATED_WINDOW,
         ...
         */
        public LightDialog (string title = "", string? window_style = Granite.StyleClass.CONTENT_VIEW_WINDOW, string? content_style = Granite.StyleClass.CONTENT_VIEW) {
            this.resizable = false;
            this.has_resize_grip = false;
            this.window_position = Gtk.WindowPosition.CENTER_ON_PARENT;

            this.close_img = Granite.Widgets.Utils.get_close_pixbuf ();
